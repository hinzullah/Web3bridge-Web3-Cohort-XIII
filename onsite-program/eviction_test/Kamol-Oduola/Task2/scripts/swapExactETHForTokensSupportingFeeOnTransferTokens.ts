...
const main = async () => {
  ...
  console.log("Preparing to swap ETH for DAI with fee-on-transfer support:");
  ...
  const tx = await ROUTER.connect(impersonatedSigner).swapExactETHForTokensSupportingFeeOnTransferTokens(
    amountOutMin,
  ...
  console.log("swapExactETHForTokensSupportingFeeOnTransferTokens executed successfully!");
