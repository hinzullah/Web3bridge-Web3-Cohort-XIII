...
export interface IercInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface Ierc extends BaseContract {
  connect(runner?: ContractRunner | null): Ierc;
  waitForDeployment(): Promise<this>;

  interface: IercInterface;
